  ...
  async fetch(request, env) {
    ...
    if (url.pathname === '/admin/approve') {
      ...
      const checkout = await createStripeCheckoutSession(env, {
        ...
        description:
          booking.booking_mode === 'hourly'
            ? `Luxtravco estimated hourly service at $${HOURLY_RATE}/hour`
            : `Luxtravco estimated transfer service at $${HOURLY_RATE}/hour`,
    ...
    const totalCents =
      estimatedHours != null ? Math.round(estimatedHours * HOURLY_RATE * 100) : null;
